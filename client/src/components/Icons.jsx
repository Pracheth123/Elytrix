// Restrained line-art icon set for adult internal medicine & diabetology —
// replaces the moodboard's pediatric motifs (per the adaptation note).
const base = {
  fill: 'none',
  stroke: 'currentColor',
  strokeWidth: 1.6,
...
// Renders a motif icon by its name in the content payload.
export function MotifIcon({ name, ...props }) {
