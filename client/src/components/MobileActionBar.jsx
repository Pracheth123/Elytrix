...
export default function MobileActionBar({ profile }) {
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-3 border-t border-softmint bg-white/95 shadow-[0_-6px_20px_-12px_rgba(47,53,49,0.25)] backdrop-blur md:hidden"
    ...
    >
      ...
      <a
        ...
        className="flex flex-col items-center gap-1 border-x border-softmint py-2.5 text-deepsage"
      >
